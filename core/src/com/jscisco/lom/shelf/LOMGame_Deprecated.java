...
import com.jscisco.lom.shelf.entity.NPCRepository;
import com.jscisco.lom.shelf.entity.Player;
import com.jscisco.lom.shelf.entity.PlayerFactory;
import com.jscisco.lom.shelf.items.ItemRepository;
import com.jscisco.lom.shelf.screens.ScreenManager;
import com.jscisco.lom.shelf.screens.ZoneScreen;
import com.jscisco.lom.shelf.screens.kingdom.HireHeroScreen;
import com.jscisco.lom.shelf.states.State;
import com.jscisco.lom.shelf.zone.Zone;
...
public class LOMGame_Deprecated extends Game {

    private Logger logger = LoggerFactory.getLogger(LOMGame_Deprecated.class);
